...
if ($result->num_rows > 0) {
    ...
    // Add 100 points to the user's points column in the registrar_usuarios table
    ...
    // Bind the user ID to the update query
    ...
    if ($updateStmt->affected_rows > 0) {
        ...
        echo json_encode(array("message" => "Failed to update user points"));
    }
