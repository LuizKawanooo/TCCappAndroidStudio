...
<div class="footer">
    ...
    <div class="gen">
        <h1>GÊNEROS</h1>
        <a style="color: white; text-decoration: none;" href="?search=" class="btn-todos"><div class="generos" data-genero="Infantil">Infantil</div></a>
        <div class="generos" data-genero="Todos">Todos</div>
...
<div id="popup" class="popup">
    <div class="table">
        ...
        <form action="upload_livros.php" method="post" enctype="multipart/form-data"> <!-- Adicionado enctype para envio de arquivos -->
