...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if (isset($_FILES['imagem']) && $_FILES['imagem']['error'] == UPLOAD_ERR_OK) {
        ...
        if (move_uploaded_file($_FILES['imagem']['tmp_name'], $targetFile)) {
            ...
            if ($stmtInsert->execute([$titulo, $autor, $genero, $editora, $tombo, $ano, $classificacao, $n_paginas, $isbn, $targetFile])) {
            ...
            header("Location: livros.php?message=Erro ao mover o arquivo.");
            exit;
        }
    } else {
