...
if ($result->num_rows > 0) {
    ...
    echo '<div class="search-result-header">Data da Ordem</div>';
    echo '<div class="search-result-header">Razão Social</div>';
    echo '<div class="search-result-header">Número de Série</div>';
    echo '<div class="search-result-header">Entregar no Dia</div>';
    echo '</div>';
